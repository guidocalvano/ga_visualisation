...
function InfiniteLine({parent, direction, position}) {
    var [line, setLine] = useState(() => {
        ...
        l.onBeforeRender= (renderer, scene, camera, geometry, material, group) => {
            ...
            let nearPlane = frustum.planes[5];
            let farPlane = frustum.planes[4];

            let sidePlanes = frustum.planes.slice(0, 4);
            
            let leftPlane = frustum.planes[0];
            let rightPlane = frustum.planes[1];

            let topPlane = frustum.planes[2];
            let bottomPlane = frustum.planes[3];
        };
    });
}
